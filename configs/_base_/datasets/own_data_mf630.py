...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_prefix='test_classification/220516_mf630/train/train',
        classes='test_classification/220516_mf630/classes.txt',
        pipeline=train_pipeline),
    test=dict(
        type=dataset_type,
        data_prefix='test_classification/220516_mf630/test/test',
    ...
    val=dict(
        ...
        type=dataset_type,
        data_prefix='test_classification/220516_mf630/valid/valid',
